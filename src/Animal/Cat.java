...
public class Cat extends Animal {
    ...
    public Cat(int cost, int age, float weight, String sex, String color, String species, String diet, String life_cycle) {
        this.id = id;
        this.age = age;
        this.color = color;
        this.cost = cost;
    ...
    public void setDatabase() throws ClassNotFoundException, SQLException, NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {
        ...
        try {
            ...
            String sql = "INSERT cats(id , cost , age, weight, sex, color,diet, species, Life_cycle) values (?,?,?,?,?,?,?,?,?)";
