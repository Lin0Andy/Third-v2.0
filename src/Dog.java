...
public class Dog extends Animal{
    ...
    protected Dog(int cost, int age,float weight, String sex, String color,String abilities, String species, String diet, String life_cycle){
        this.id = id;
        this.age = age;
        this.color = color;
    ...
    void setDatabase() throws ClassNotFoundException, SQLException, NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {
        ...
        try {
            ...
            String sql = "INSERT birds(id , cost , age, weight, sex, color,, abilities, diet, species, Life_cycle) values (?, ?,?,?,?,?,?,?,?,?)";
